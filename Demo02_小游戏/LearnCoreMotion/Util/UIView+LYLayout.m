...
- (void)setSsCornerRadius:(CGFloat)ssCornerRadius {
    self.layer.cornerRadius = ssCornerRadius;
    self.layer.masksToBounds = YES;
}

- (CGFloat)ssCornerRadius {
...
- (void)setRoundCornerWithadius:(CGFloat)radius rect:(CGRect)rect corners:(UIRectCorner)corners {
    UIBezierPath *cornerMaskPath = [UIBezierPath bezierPathWithRoundedRect:rect byRoundingCorners:corners cornerRadii:CGSizeMake(radius, radius)];
    CAShapeLayer *cornerMaskLayer = [[CAShapeLayer alloc] init];
    cornerMaskLayer.frame = rect;
